        ...
        for i in range(3):
            for j in range(3):
                if(show_tab[i,j] == None):
                    show_tab[i,j]='\033[37m Ø \033[39m'
                elif show_tab[i,j].pion != None:
                    if(show_tab[i,j].pion.couleur == "rouge"):
                        I_d = str(show_tab[i,j].pion.i_d)
                        show_tab[i,j]='\033[31mp'+I_d+' \033[39m'
                    else:
                        I_d = str(show_tab[i,j].pion.i_d)
                        show_tab[i,j]='\033[34mp'+I_d+' \033[39m'                        
                    #show_tab[i,j]='N - pion'+I_d+' '+ show_tab[i,j].pion.couleur
                else: 
                    show_tab[i,j]= '\u001b[30m N \u001b[0m'
        print("\t\t    0       1       2     ")    
        print("\t\t#=======================#")  
        print("\t\t#_______________________#")
        for i in range(3):
            print("\t\t#       |       |       #")
            print("\t",i,"\t# ",show_tab[i,0]," | ",show_tab[i,1]," | ",show_tab[i,2]," #")
